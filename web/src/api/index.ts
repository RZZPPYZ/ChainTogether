...
export type PersonaRead = components["schemas"]["PersonaRead"];
export type PersonaResourceInfo = components["schemas"]["PersonaResourceInfo"];
...
export type PersonaImportRequest = components["schemas"]["PersonaImportRequest"];
